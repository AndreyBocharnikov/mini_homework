...
TEST(copy_on_write, push_back_simple)
{
    faulty_run([]
               {
                   counted::no_new_instances_guard g;
...
TEST(copy_on_write, assignment_empty)
{
    faulty_run([]
               {
                   counted::no_new_instances_guard g;
...
TEST(copy_on_write, erase_range_begin)
{
    faulty_run([]
               {
                   counted::no_new_instances_guard g;
...
TEST(copy_on_write, erase_range_middle)
{
    faulty_run([]
               {
                   counted::no_new_instances_guard g;
                   ...
                   EXPECT_EQ(6u, d.size());
                   EXPECT_EQ(15, *(d.begin() + 2));
               });
}

TEST(copy_on_write, erase_range_middle_2)
{
    faulty_run([]
               {
                   counted::no_new_instances_guard g;
...
TEST(correctness, erase_range_all_but_one)
{
    faulty_run([]
               {
                   counted::no_new_instances_guard g;
...
TEST(copy_on_write, erase_range_all)
{
    faulty_run([]
               {
                   counted::no_new_instances_guard g;
...
TEST(copy_on_write, push_back_element_of_itself)
{
    faulty_run([]
               {
                   counted::no_new_instances_guard g;
...
TEST(correctness, shrink_to_fit) {
    faulty_run([]
    {
        ...
        c.push_back(12);
        c.shrink_to_fit();
        EXPECT_EQ(4u, c.capacity());
    });
}

TEST(copy_on_write, shrink_to_fit) {
    faulty_run([]
               {
                   counted::no_new_instances_guard g;
                   container c;
                   ...
                   c.shrink_to_fit();
                   EXPECT_EQ(4u, c.capacity());
                   EXPECT_EQ(6u, d.capacity());
               });
}

TEST(copy_on_write, clear) {
    faulty_run([]
               {
                   counted::no_new_instances_guard g;
                   container c;
